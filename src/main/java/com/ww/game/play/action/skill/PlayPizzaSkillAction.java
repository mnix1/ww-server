...
public class PlayPizzaSkillAction extends PlayAction {

    public PlayPizzaSkillAction(PlayManager manager) {
        super(manager);
    }
    ...
    public void perform(Long profileId, Map<String, Object> content) {
        ...
        if (!warTeam.getTeamSkills().canUse(Skill.PIZZA)
        ...
        ((PlayWarFlow) getFlow()).skillAction(new PlaySkillPizzaActionState(manager, warTeam, warOpponentTeam));
    }
}
