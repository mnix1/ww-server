...
public class PlayNinjaSkillAction extends PlayAction {

    public PlayNinjaSkillAction(PlayManager manager) {
        super(manager);
    }
    ...
    public void perform(Long profileId, Map<String, Object> content) {
        ...
        if (!warTeam.getTeamSkills().canUse(Skill.NINJA)
        ...
        ((PlayWarFlow) getFlow()).skillAction(new PlaySkillNinjaActionState(manager, warTeam, warOpponentTeam));
    }
}
