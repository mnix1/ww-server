...
public class PlaySkillPreparingCoverallState extends PlaySkillState {

    public PlaySkillPreparingCoverallState(PlaySkillFlow flow, MemberWisieManager manager) {
        super(flow, manager);
    }
