...
public class WarStateCoverallUsed extends WarState {
    private Long profileId;

    public WarStateCoverallUsed(WarManager manager, Long profileId) {
    ...
    protected void processVoid() {
        ...
        if (!team.getTeamSkills().canUse(Skill.COVERALL)
        ...
        team.getTeamSkills().use(Skill.COVERALL);
        ...
        wisieAnswerManager.getFlow().getCoverallSkillFlow().coverall(opponentWisieAnswerManager);
