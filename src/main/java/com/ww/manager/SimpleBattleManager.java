...
//    private static final Logger logger = LoggerFactory.getLogger(SimpleBattleManager.class);
...
//
//
//    public SimpleBattleManager(BattleFriendContainer bic, BattleService battleService, ProfileConnectionService profileConnectionService) {
...
//            Map<String, Object> model = new HashMap<>();
//            fillModelAnswering(model, battleProfileContainer);
//            send(model, Message.BATTLE_INTRO, battleProfileContainer.getProfileId());
//        });
//    }
//
...
//                    profileIdBattleProfileContainerMap.values().parallelStream().forEach(battleProfileContainer -> {
//                        send(model, Message.BATTLE_ANSWERING, battleProfileContainer.getProfileId());
//                    });
//                });
//    }
//
