...
public class StateStartSearchingAnswer extends State {
    protected static final Logger logger = LoggerFactory.getLogger(StateStartSearchingAnswer.class);
    private static final double MIN_START_SEARCHING_ANSWER_INTERVAL = 0.5;

    public StateStartSearchingAnswer(HeroAnswerManager manager) {
        super(manager);
    }
    ...
    protected Flowable<Long> processFlowable() {
        ...
        logger.debug(manager.getHero().getHero().getNamePolish() + ", " + manager.lastAction().name() + ", reflexF1: " + reflexF1 + ", concentrationF1: " + reflexF1 + ", interval: " + interval);
